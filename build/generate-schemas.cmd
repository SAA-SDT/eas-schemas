...
java %parameters% %CP% net.sf.saxon.Transform -s:..\xml-schemas\ead\ead.rng -xsl:transformations\add-comments-and-metadata.xsl -o:..\xml-schemas\ead\ead-4-dev.rng -warnings:silent
...
java %parameters% %CP% net.sf.saxon.Transform -s:..\xml-schemas\ead\ead.xsd -xsl:transformations\update-namespace-prefix-in-xsd.xsl -o:..\xml-schemas\ead\ead-4-dev.xsd -warnings:silent
