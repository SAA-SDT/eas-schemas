...
java -cp $saxon net.sf.saxon.Transform -s:../xml-schemas/ead/ead-4-dev.rng -xsl:transformations/add-comments-and-metadata.xsl -o:../xml-schemas/ead/ead-4-dev.rng schema='ead'
